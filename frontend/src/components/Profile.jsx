...
const Profile = () => {
  ...
  return (
    <div className='flex max-w-5xl justify-center ml-[16%] pl-10'>
          ...
          <section>
            <div className='flex flex-col gap-7'>
              ...
              <div className='flex flex-col gap-2'>
                <span className='font-semibold'>{userProfile?.bio || 'bio goes here...'}</span>
          ...
          <div className='grid grid-cols-3 gap-1'>
            {
              displayedPost?.map((post) => {
                return (
                  <div key={post?._id} className='relative group cursor-pointer ml-10 pl-10'>
